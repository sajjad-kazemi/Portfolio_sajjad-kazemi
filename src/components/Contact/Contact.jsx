  ...
  return (
    <section className={style.section}>
      <div className={style.infoList}>
        ...
        <div className={`${style.git} ${style.info}`}><a href="https://github.com/sajjad-kazemi">/sajjad-kazemi</a><Github/></div>
      ...
      <input className={style.userName} required type="text" name="user_name" />
      <label htmlFor="user_email">Email(required)</label>
      <input className={style.userEmail} required type="email" name="user_email" />
      <label>Message</label>
      <textarea className={style.userMessage} required rows="6" name="message" />
      <input name="send" className={style.submit} type="submit" value="Send" />
      <label htmlFor="send" className={style.success}  style={success} >Success</label>
    </form>
      </div>
    </section>
  )
